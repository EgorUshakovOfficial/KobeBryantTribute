...
If you click on the icon located on the top right of the page, you'll see a selection menu. Click on it and choose the "Tribute Page" option. After you do, you'll be able to run tests against the HTML and CSS files in this repository. A project on freeCodeCamp is considered complete when all the rests ran against files in the repository are passed. If you run the tests of the selected option, then you'll all of them are passed; thus, marking this project as complete. 
